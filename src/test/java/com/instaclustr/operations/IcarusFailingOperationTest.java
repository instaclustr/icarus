...
public class IcarusFailingOperationTest {

    @Inject
    OperationsResource operationsResource;

    private static final class FailingDecommissionOperation extends Operation<DecommissionOperationRequest> {

        private final CountDownLatch countDownLatch;

        protected FailingDecommissionOperation(DecommissionOperationRequest request, CountDownLatch countDownLatch) {
            super(request);
        ...
        protected void run0() throws Exception {
            ...
            throw new RuntimeException("this is exception", new RuntimeException("this is cause"));
        }
    }
    ...
    public void setup() {
        ...
        final Map<Class<? extends OperationRequest>, OperationFactory> typeMap = new HashMap<Class<? extends OperationRequest>, OperationFactory>() {{
            put(DecommissionOperationRequest.class, (OperationFactory<DecommissionOperationRequest>) request -> new FailingDecommissionOperation(request, operationCountDownLatch));
        }};
    ...
    public void testFailingOperation() throws Exception {
        ...
        assertEquals(finishedOperation.state, Operation.State.FAILED);
    }
